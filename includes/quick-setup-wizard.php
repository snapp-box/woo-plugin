...
if (! class_exists('\Snappbox\SnappBox_Quick_Setup')) {
  class SnappBox_Quick_Setup
  {
    ...
    public function snappb_render_page(): void
    {
      ...
      switch ($step) {
        case 1:
          $this->snappb_render_step_1();
          break;           // API Token
        case 2:
          $this->snappb_render_step_3();
          break;           // Map Setup (was step 3)
        case 3:
          $this->snappb_render_step_4();
          break;           // Store Info (was step 4)
        case 4:
          $this->snappb_render_step_5();
          break;           // Other Info (was step 5)
        default:
          $this->snappb_render_step_1();
          break;
      }
    ...
    public function snappb_handle_save(): void
    {
      ...
      switch ($step) {
        ...
        case 1: {
          ...
          // Step 2: Map Setup (previously step 3)
        case 2: {
          ...
          // Step 3: Store Info (previously step 4)
        case 3: {
